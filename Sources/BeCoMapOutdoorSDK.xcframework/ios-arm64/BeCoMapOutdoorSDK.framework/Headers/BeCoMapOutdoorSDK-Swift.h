...
#ifndef BECOMAPOUTDOORSDK_SWIFT_H
#define BECOMAPOUTDOORSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BeCoMapOutdoorSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// copyright:
/// Copyright © 2019 GlobeCo Technologies Pvt Ltd. All rights reserved.
SWIFT_CLASS("_TtC17BeCoMapOutdoorSDK10BECategory")
@interface BECategory : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly, copy) NSString * _Nonnull arabicName;
@property (nonatomic, readonly, copy) NSString * _Nonnull englishName;
...
typedef SWIFT_ENUM(NSInteger, BECustomPointType, open) {
  BECustomPointTypeCurrentLocation = 0,
  BECustomPointTypeParking = 1,
  BECustomPointTypeRouteStarting = 2,
  BECustomPointTypeRouteEnding = 3,
  BECustomPointTypeOther = 4,
};

typedef SWIFT_ENUM(NSInteger, BELanguage, open) {
  BELanguageEnglish = 0,
  BELanguageArabic = 1,
};
...
/// copyright:
/// Copyright © 2019 GlobeCo Technologies Pvt Ltd. All rights reserved.
SWIFT_CLASS("_TtC17BeCoMapOutdoorSDK10BELocation")
...
/// author:
/// Mithin Thomas
SWIFT_CLASS("_TtC17BeCoMapOutdoorSDK6BEView")
...
SWIFT_CLASS("_TtC17BeCoMapOutdoorSDK9BEMapView")
...
///
- (void)loadSite:(NSString * _Nonnull)siteIdentifier name:(NSString * _Nonnull)name language:(enum BELanguage)language;
/// func selectPoint
/// <ul>
///   <li>
///     select a point
///   </li>
/// </ul>
/// \param id [String] Node Name
///
- (void)selectPointWithName:(NSString * _Nonnull)name;
/// func drawRouteWith
/// <ul>
///   <li>
...
///   </li>
/// </ul>
/// \param pointIds [String]point Names
///
/// \param startForUserlocation Bool value which will drow route from user location.
///
- (void)drawRouteWithName:(NSArray<NSString *> * _Nonnull)pointNames startForUserlocation:(BOOL)startForUserlocation;
/// func drawRouteWith
/// <ul>
///   <li>
...
///   </li>
/// </ul>
- (void)drawRouteToLocation:(CLLocationCoordinate2D)location with:(NSString * _Nonnull)name;
/// func resetMap
/// <ul>
///   <li>
...
SWIFT_PROTOCOL("_TtP17BeCoMapOutdoorSDK17BEMapViewDelegate_")
...
SWIFT_CLASS("_TtC17BeCoMapOutdoorSDK7BEPoint")
@interface BEPoint : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly, copy) NSString * _Nonnull pointDescription;
...
/// copyright:
/// Copyright © 2019 GlobeCo Technologies Pvt Ltd. All rights reserved.
SWIFT_CLASS("_TtC17BeCoMapOutdoorSDK9BESession")
...
/// copyright:
/// Copyright © 2019 GlobeCo Technologies Pvt Ltd. All rights reserved.
SWIFT_CLASS("_TtC17BeCoMapOutdoorSDK6BESite")
...
/// copyright:
/// Copyright © 2019 GlobeCo Technologies Pvt Ltd. All rights reserved.
SWIFT_CLASS("_TtC17BeCoMapOutdoorSDK12BeCoServices")
